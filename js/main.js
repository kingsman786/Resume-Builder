...
document.querySelector('#page2').contentEditable=true;
document.querySelector('#page21').contentEditable=true;
document.querySelector('#page1').contentEditable=true;
...
function template(value)
{
	if(value=='default')
	{
		...
		$('#anotherTemplateBtn').removeClass('btn-danger').addClass('btn-default');
	...
	{
		$('#anotherTemplateBtn').removeClass('btn-default').addClass('btn-danger');
		$('#customTemplateBtn').removeClass('btn-danger').addClass('btn-default');
		$('#defaultTemplateBtn').removeClass('btn-danger').addClass('btn-default');
		$('#customTemplateOptions').hide();
		$('#page').hide();
